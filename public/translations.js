const translations = {
  es: {
    ...
    meta_description: "Transformamos tu crédito en capital para hacer crecer tu empresa. Servicios de reparación de crédito y financiamiento empresarial.",
    meta_keywords: "crédito empresarial, financiamiento, reparación de crédito, capital de trabajo, préstamos comerciales",
    og_description: "Abrimos las puertas del financiamiento para tu futuro empresarial",
    twitter_description: "Abrimos las puertas del financiamiento para tu futuro empresarial",
    ...
    nav_proceso: "Proceso",
    nav_valor: "Valor",
    nav_financiamiento: "Financiamiento",
    ...
    credit_transformer_subtitle: "Nuestro programa exclusivo transforma tu perfil crediticio, eliminando barreras y creando oportunidades.",
    credit_before_title: "Crédito Cuestionable",
    credit_before_1: "Información inexacta",
    credit_before_2: "Errores de reporte",
    credit_before_3: "Cuentas obsoletas",
    credit_after_title: "Crédito Sólido",
    credit_after_1: "Mejores tasas de interés",
    credit_after_2: "Acceso a hipotecas",
    credit_after_3: "Aprobaciones rápidas",
    accordion_process_title: "Nuestro Proceso en 5 Pasos",
    accordion_process_1: "<strong>Análisis Inicial:</strong> Identificamos cada detalle de tu historial crediticio.",
    accordion_process_2: "<strong>Plan Estratégico:</strong> Diseñamos una estrategia personalizada para tu caso.",
    accordion_process_3: "<strong>Disputas Efectivas:</strong> Presentamos y damos seguimiento a las disputas ante las agencias.",
    accordion_process_4: "<strong>Monitoreo Constante:</strong> Te mantenemos informado con reportes periódicos de tu progreso.",
    accordion_process_5: "<strong>Educación Financiera:</strong> Te damos las herramientas para mantener un crédito fuerte a futuro.",
    accordion_benefits_title: "Beneficios e Inversión",
    accordion_benefits_1: "<strong>Transparencia Total:</strong> Reportes claros y sin letras pequeñas.",
    accordion_benefits_2: "<strong>Resultados Medibles:</strong> Actualizaciones constantes para que veas tu progreso.",
...
financing_item3_desc: "Para inversiones en bienes raíces",
    ...
    service_1_title: "Reparación de Crédito",
    service_1_desc: "Mejoramos tu historial crediticio eliminando errores y optimizando tu perfil para nuevas oportunidades.",
    service_2_title: "Financiamiento Empresarial",
    service_2_desc: "Accede a capital de trabajo, líneas de crédito y préstamos para impulsar el crecimiento de tu negocio.",
    service_3_title: "Asesoría Financiera",
    service_3_desc: "Guía experta para tomar decisiones financieras inteligentes y construir un futuro sólido.",

    // --- Sección Proceso ---
    process_title: "Nuestro Proceso Paso a Paso",
    process_step1_title: "Evaluación Inicial",
    process_step1_desc: "Revisamos a fondo tu situación financiera y tu perfil de crédito para identificar fortalezas y áreas de oportunidad.",
    process_step2_title: "Diseño de Estrategia",
    process_step2_desc: "Creamos un plan de acción y preparamos un expediente sólido y atractivo, diseñado para destacar ante bancos e inversionistas.",
    process_step3_title: "Búsqueda y Aplicación",
    process_step3_desc: "Identificamos las mejores opciones de financiamiento en nuestra red de contactos y presentamos las solicitudes de manera estratégica.",
    process_step4_title: "Negociación y Apoyo",
    process_step4_desc: "Te guiamos y representamos en cada reunión y negociación, asegurando que obtengas las mejores condiciones posibles.",
    process_step5_title: "Aprobación y Desembolso",
    process_step5_desc: "Celebramos contigo. Te apoyamos hasta el final, asegurando que el capital sea desembolsado y esté listo para impulsar tu negocio.",
...
validation_phone: "Por favor, ingresa un teléfono válido",
    ...
    footer_copyright: "&copy; 2024 ARES Credit Capital Inc. Todos los derechos reservados.",
  ...
  en: {
    // --- Meta Tags ---
    meta_description: "We transform your credit into capital to grow your business. Credit repair and business financing services.",
    meta_keywords: "business credit, financing, credit repair, working capital, commercial loans",
    og_description: "We open the doors to financing for your business future",
    twitter_description: "We open the doors to financing for your business future",
    ...
    hero_title_2: "We transform your <span class=\"text-gradient\">profile</span> into <span class=\"text-gradient\">capital</span>.",
    hero_subtitle: "From repairing your history to obtaining financing, we are your strategic partner for business growth.",
    hero_btn_1: "Get Started Now",
    hero_btn_2: "Learn More",

    // --- Credit Transformer Section ---
    credit_transformer_title: "From Questionable to Reliable",
    credit_transformer_subtitle: "Our exclusive program transforms your credit profile, removing barriers and creating opportunities.",
    credit_before_title: "Questionable Credit",
    credit_before_1: "Inaccurate information",
    credit_before_2: "Reporting errors",
    credit_before_3: "Obsolete accounts",
    credit_after_title: "Solid Credit",
    credit_after_1: "Better interest rates",
    credit_after_2: "Access to mortgages",
    credit_after_3: "Fast approvals",
    accordion_process_title: "Our 5-Step Process",
    accordion_process_1: "<strong>Initial Analysis:</strong> We identify every detail of your credit history.",
    accordion_process_2: "<strong>Strategic Plan:</strong> We design a personalized strategy for your case.",
    accordion_process_3: "<strong>Effective Disputes:</strong> We file and follow up on disputes with agencies.",
    accordion_process_4: "<strong>Constant Monitoring:</strong> We keep you informed with periodic progress reports.",
    accordion_process_5: "<strong>Financial Education:</strong> We give you the tools to maintain strong credit in the future.",
    accordion_benefits_title: "Benefits and Investment",
    accordion_benefits_1: "<strong>Total Transparency:</strong> Clear reports with no fine print.",
    accordion_benefits_2: "<strong>Measurable Results:</strong> Constant updates so you can see your progress.",
    accordion_benefits_3: "<strong>Professional Support:</strong> Experts from the U.S. financial system by your side.",
...
financing_item3_desc: "For real estate investments",
    ...
    service_1_desc: "We improve your credit history by removing errors and optimizing your profile for new opportunities.",
    service_2_title: "Business Financing",
    service_2_desc: "Access working capital, lines of credit, and loans to boost your business growth.",
    service_3_title: "Financial Advisory",
    service_3_desc: "Expert guidance to make smart financial decisions and build a solid future.",

    // --- Process Section ---
    process_title: "Our Step-by-Step Process",
    process_step1_title: "Initial Assessment",
    process_step1_desc: "We thoroughly review your financial situation and credit profile to identify strengths and areas of opportunity.",
    process_step2_title: "Strategy Design",
    process_step2_desc: "We create an action plan and prepare a solid and attractive file, designed to stand out to banks and investors.",
    process_step3_title: "Search and Application",
    process_step3_desc: "We identify the best financing options in our network of contacts and strategically submit applications.",
    process_step4_title: "Negotiation and Support",
    process_step4_desc: "We guide and represent you in every meeting and negotiation, ensuring you get the best possible conditions.",
    process_step5_title: "Approval and Disbursement",
    process_step5_desc: "We celebrate with you. We support you until the end, ensuring that capital is disbursed and ready to boost your business.",
...
validation_phone: "Please enter a valid phone number",
    ...
    footer_copyright: "&copy; 2024 ARES Credit Capital Inc. All rights reserved.",
